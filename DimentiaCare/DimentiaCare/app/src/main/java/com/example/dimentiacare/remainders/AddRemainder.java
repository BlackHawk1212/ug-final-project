...
public class AddRemainder extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Sqlitedb.CreateTabels(AddRemainder.this, "MyEvents",
                false, "eventname,eventdate,eventtime");
    ...
    private void submit() {
        ...
        if (text.isEmpty()) {
            ...
            if (btn_time.getText().toString().equals("Select Time") || btn_date.getText().toString().equals("Select date")) {
                ...
                Sqlitedb.InsertData(AddRemainder.this, "MyEvents",
                        "eventname,eventdate,eventtime",
                        "'" + value + "','"
                                + date + "','"
                                + time + "'");
                setAlarm(value, date, time);
                Intent intent = new Intent (AddRemainder.this, MainRemainder.class);
